		...
		var db = F2(
			function (parentId, comments) {
				...
				if (_p19.ctor === 'Success') {
					return A3(_elm_lang$core$Dict$insert, parentId, _p19._0, feed.index);
				} else {
					return feed.index;
				}
			});
		...
		switch (_p20.ctor) {
			case 'FetchStories':
				return {
					...
					_1: _skrypte$elm_hnpwa$Hnpwa$getItems(_p20._0)
				};
			case 'FetchSingleItem':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						feed,
						{data: _p21, now: _p20._0._0}),
					_1: _skrypte$elm_hnpwa$Hnpwa$getKidsOfSeveral(_p21)
				};
			case 'ChainItems':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						feed,
						{data: _p20._0._1, now: _p20._0._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChainComments':
				var _p23 = _p20._0._2;
				var _p22 = discuss(_p23);
				var i = _p22._0;
				var c = _p22._1;
				return {
					ctor: '_Tuple2',
			...
			default:
				if (_p20._0.ctor === 'Just') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							feed,
							{page: _p24, comments: _krisajenkins$remotedata$RemoteData$NotAsked, index: _elm_lang$core$Dict$empty}),
						_1: _skrypte$elm_hnpwa$Hnpwa$getPage(_p24)
					};
				} else {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
...
var _skrypte$elm_hnpwa$Hnpwa$init = function (loc) {
	var _p25 = _skrypte$elm_hnpwa$Hnpwa$pathto(loc);
	if (_p25.ctor === 'Just') {
		switch (_p25._0.ctor) {
			case 'Blank':
				return {
			...
			default:
				return {
					...
					_1: _skrypte$elm_hnpwa$Hnpwa$getPage(
						_skrypte$elm_hnpwa$Hnpwa$SingleItem(_p25._0._0))
				};
		}
	} else {
...
var _skrypte$elm_hnpwa$Hnpwa$page = function (feed) {
					...
					return _elm_lang$core$Basics$toString(
						_elm_lang$core$List$length(
							A2(
								_elm_lang$core$Maybe$withDefault,
								{ctor: '[]'},
								A2(_elm_lang$core$Dict$get, _p26._0, feed.index))));
				} else {
					return '-1';
				}
			} else {
							...
							_0: _elm_lang$html$Html_Attributes$id(
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										'-',
										_elm_lang$core$Basics$toString(_p30.id)))),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class(_p30.type_),
								_1: {
									ctor: '::',
	...
	var pushComment = F2(
		function (items, _p31) {
			...
			var siblingOf = function (comment) {
					...
					function (comment, inList) {
						...
						while (true) {
							...
							if (_p33.ctor === '[]') {
								...
								if (_elm_lang$core$Native_Utils.eq(_p33._0.id, comment.item.id)) {
									return _elm_lang$core$List$head(_p33._1);
								} else {
									var _v22 = comment,
				...
				var inList = function () {
					var _p34 = comment.parent;
					if (_p34.ctor === 'Just') {
						return A2(
							_elm_lang$core$Maybe$withDefault,
							_skrypte$elm_hnpwa$Hnpwa$nolist,
							A2(_elm_lang$core$Dict$get, _p34._0.id, feed.index));
					} else {
				...
				return _elm_lang$core$Native_Utils.eq(sibling, comment.item) ? comment : {
					parent: A2(parent, _p39.id, items),
					item: sibling,
			...
			var i = A2(
				...
				_elm_lang$core$List$head(
					A2(
						_elm_lang$core$Maybe$withDefault,
						_skrypte$elm_hnpwa$Hnpwa$nolist,
						A2(_elm_lang$core$Dict$get, _p39.id, feed.index))));
			var c = {
				parent: A2(parent, _p39.id, items),
				item: i,
				index: 0,
	...
	var knode = F2(
		function (items, _p40) {
			...
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toString(_p42),
				_1: A2(
					htmlContent,
					items,
	...
	var htmlContent = F2(
		function (items, _p43) {
			...
			var _p46 = _p44._1;
			var _p45 = _p44._0;
			var mainContent = (!_elm_lang$core$Native_Utils.eq(_p46.type_, 'comment')) ? A2(
				_elm_lang$core$List$map,
				_elm_lang$core$Tuple$mapFirst(_elm_lang$core$Basics$toString),
				A2(
					_elm_lang$core$List$indexedMap,
					...
					A2(
						_skrypte$elm_hnpwa$Hnpwa$story,
						feed,
						{ctor: '_Tuple2', _0: _p45, _1: _p46}))) : _skrypte$elm_hnpwa$Hnpwa$nolist;
			return A2(
				_elm_lang$html$Html_Lazy$lazy,
				A2(
					_elm_lang$html$Html_Keyed$node,
						...
						_0: _elm_lang$html$Html_Attributes$id(
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'-',
									_elm_lang$core$Basics$toString(_p46.id)))),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(_p46.type_),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$tabindex(0),
								_1: {
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$width(160),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$height(68),
								_1: {
									ctor: '::',
