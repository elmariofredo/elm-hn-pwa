...
var _skrypte$elm_hnpwa$Hnpwa$page = function (feed) {
	var appendToStories = F2(
		function (comments, stories) {
			return A2(_elm_lang$core$List$append, stories, comments);
		});
	...
	var stories = function (inList) {
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$concatMap,
					_skrypte$elm_hnpwa$Hnpwa$story(feed),
					indexed(inList))));
	};
	var setSize = F2(
		function (li, item) {
	...
	var pushComment = F2(
		function (items, _p27) {
			...
			var siblingOf = function (comment) {
					...
					function (comment, inList) {
						...
						while (true) {
							...
							if (_p29.ctor === '[]') {
								...
								if (_elm_lang$core$Native_Utils.eq(_p29._0.id, comment.item.id)) {
									return _elm_lang$core$List$head(_p29._1);
								} else {
									var _v21 = comment,
										_v22 = A2(_elm_lang$core$List$drop, 1, inList);
									comment = _v21;
									inList = _v22;
									continue siblingOf_;
								}
				...
				var inList = function () {
					var _p30 = comment.parent;
					if (_p30.ctor === 'Just') {
						return A2(
							_elm_lang$core$Maybe$withDefault,
							_skrypte$elm_hnpwa$Hnpwa$nolist,
							A2(_elm_lang$core$Dict$get, _p30._0.id, feed.index));
					} else {
				...
				return _elm_lang$core$Native_Utils.eq(sibling, comment.item) ? comment : {
					parent: A2(parent, _p35.id, items),
					item: sibling,
			...
			var i = A2(
				...
				_elm_lang$core$List$head(
					A2(
						_elm_lang$core$Maybe$withDefault,
						_skrypte$elm_hnpwa$Hnpwa$nolist,
						A2(_elm_lang$core$Dict$get, _p35.id, feed.index))));
			var c = {
				parent: A2(parent, _p35.id, items),
				item: i,
				index: 0,
	...
	var knode = F2(
		function (items, _p36) {
			...
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toString(_p38),
				_1: A2(
					htmlContent,
					items,
					{ctor: '_Tuple2', _0: _p38, _1: _p37._1})
			};
		});
	var htmlContent = F2(
		function (items, _p39) {
						...
						_0: _elm_lang$html$Html_Attributes$id(
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'-',
									_elm_lang$core$Basics$toString(_p42.id)))),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(_p42.type_),
							_1: {
								ctor: '::',
